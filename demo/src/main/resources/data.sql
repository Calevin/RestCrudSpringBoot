...
-- Contraseña: Admin1
insert into usuarios (id, username, password, avatar, fecha_creacion, fecha_ultima_modificacion_password) 
values (1, 'admin','$2a$10$vPaqZvZkz6jhb7U7k/V/v.5vprfNdOnh4sxi/qpPRkYTzPmFlI9p2','https://api.adorable.io/avatars/285/admin@openwebinars.net.png',CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
insert into usuarios (id, username, password, avatar, fecha_creacion, fecha_ultima_modificacion_password) 
values (2, 'marialopez','$2a$10$3i95KIxdl8igcpDby.URMOgwdDR2q9UaSfor2kJJrhAPfNOC/HMSi','https://api.adorable.io/avatars/285/maria.lopez@openwebinars.net.png',CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

insert into usuario_roles (usuario_id, roles) values (2,'USER');

-- Contraseña: Angelmartinez1
insert into usuarios (id, username, password, avatar, fecha_creacion, fecha_ultima_modificacion_password) 
values (3, 'angelmartinez','$2a$10$37IEM6zzuwXqFrotYDtySOKITKfeNWR3NBRqcM7JYWnBDIaq9ByZm','https://api.adorable.io/avatars/285/angel.martinez@openwebinars.net.png',CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

insert into usuario_roles (usuario_id, roles) values (3,'USER');

-- Contraseña: Anajimenez1
insert into usuarios (id, username, password, avatar, fecha_creacion, fecha_ultima_modificacion_password) 
values (4, 'anajimenez','$2a$10$k0om5gtNBheWX54VzD1E0etCnqC0xChHjfW3lOXaeCpN5ST1vVGYm','https://api.adorable.io/avatars/285/ana.jimenez@openwebinars.net.png',CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
